...
namespace WebApplication1.Controllers
{
    public class OOADSampionatsController : Controller
    {
        ...
        {
            var oOADSampionats = db.OOADSampionats.Include(o => o.OOADTimovi);
            return View(oOADSampionats.ToList());
        }
        ...
        {
            ViewBag.TimoviID = new SelectList(db.OOADTimovis, "ID", "Ime");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,Naziv,TimoviID")] OOADSampionat oOADSampionat)
        {
            ...
            ViewBag.TimoviID = new SelectList(db.OOADTimovis, "ID", "Ime", oOADSampionat.TimoviID);
            return View(oOADSampionat);
        }
